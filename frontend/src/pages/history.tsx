        ...
        <ContentContainer>
            <div>
                ...
                <TextSection title="New Imperialism">
                    <TextSectionParagraph>
                        The period of New Imperialism (1875 to 1914) marked an era of unprecedented Euro-American
                ...
                <TextSection title="Jim Crow Laws">
                    <TextSectionParagraph>
                        After the American civil war and the abolition of slavery, a series of laws were passed
                ...
                <TextSection title="Yellow Peril and Asian Exclusion">
                    <TextSectionParagraph>
                        The late-nineteenth century witnessed tremendous anxiety about the supposed massive influx of
                ...
                <TextSection title="Women's Suffrage">
                    <TextSectionParagraph>
                        During the peak period of trade card and postcard circulation, white women in Britain and in
                ...
                <TextSection title="Servant Problem">
                    <TextSectionParagraph>
                        Due to the low-pay, long hours, and social stigma associated with domestic servitude, there was
                ...
                <TextSection title="Racialized Men-Servants">
                    <TextSectionParagraph>
                        Although domestic service underwent a feminization in the nineteenth century, non-white
                ...
                <TextSection title="South Asian Men-Servants">
                    <TextSectionParagraph>
                        British imperial households in India employed a large retinue of Indian men-servants who worked
                ...
                <TextSection title="Black Men-Servants/Uncle Tom stereotype">
                    <TextSectionParagraph>
                        Black men-servants, most commonly represented as the Tom stereotype, perpetuates the narrative
                ...
                <TextSection title="Chinese Men-Servants/ 'Houseboy' and 'Laundryman' stereotype">
                    <TextSectionParagraph>
                        The Chinese “houseboy” served as the answer to the pesky “servant problem” of the late 1800s.
                ...
                <TextSection title="Monkey Brand">
                    <TextSectionParagraph>
                        Black and Brown men-servants were animalized as a way to dehumanize and degrade them. This can
                ...
                <TextSection title="Racialized Maidservants">
                    <TextSectionParagraph>
                        Within the context of New Imperialism, gendered and racialized maidservants such as the South
                ...
                <TextSection title="The Indian Ayah">
                    <TextSectionParagraph>
                        The ayah figure of South Asia was a crucial facet of British colonial presence in the
                ...
                <TextSection title="Chinese Amah">
                    <TextSectionParagraph>
                        The amah figure, like the ayah, was another racialized Asian maidservant who was idolized in
                ...
                <TextSection title="Indonesian Baboe">
                    <TextSectionParagraph>
                        The baboe was the counterpart of the ayah in the Dutch Empire in Indonesia. Javanese and
                ...
                <TextSection title="Mexican Criada">
                    <TextSectionParagraph>
                        Native American domestic servants such as the Mexican criada were racialized in visual sources
                ...
                <TextSection title="The Mammy">
                    <TextSectionParagraph>
                        The African American Mammy differs from other stereotypes of Black people (the Sambo, Tom,
                ...
                <TextSection title="Working-class White Maidservants">
                    <TextSectionParagraph>
                        In the 19th century, both the United States and Britain experienced a feminization of the
                ...
                <TextSection title="The Irish 'Bridget'">
                    <TextSectionParagraph>
                        Ireland provided a significant number of domestic workers from the 1840s and onward in the U.S.,
            ...
            <div className="pb-36">
                ...
                <TextSection title="Erasure of Domestic workers' Voices">
                    <TextSectionParagraph>
                        Throughout their many stages of production and travel, our trade cards and postcards --and the
                ...
                <TextSection title="Hegemonic Construction of Whiteness">
                    <TextSectionParagraph>
                        Although the trade cards and postcards of racialized domestic workers tell us very little about
                ...
                <TextSection title="Lasting Impacts">
                    <TextSectionParagraph>
                        While the “servant problem” may be a thing of the past, paid care labor in the Global North is
