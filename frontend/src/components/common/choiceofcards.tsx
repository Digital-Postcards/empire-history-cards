...
const ChoiceOfCards = (props: { classes?: string }) => {
    return (
        <div className={`w-full grid lg:grid-cols-2 grid-cols-1 border border-neutral-400 ` + props?.classes}>
            <ChoiceCard
                type="postcard"
                title="Postcards"
                image="/images/carousel/one.jpg"
                classes="border border-black border-0 border-b lg:border-r lg:border-b-0"
            >
